...
class Handler
{
    ...
    /**
     * Change email request handler
     * @param Command $command
     * @throws DomainException if user not found / wrong email format / email already in use
     */
    public function handle(Command $command): void
    {
        ...
        $this->flusher->flush(); // save in db

        $this->sender->send($email, $token); // send email with token
    }
}
